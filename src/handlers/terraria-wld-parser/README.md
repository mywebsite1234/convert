<!--
  ...
  Author: cokolele
  Tags: typescript, terraria, world file, file structure, file dumper, file format, documentation, data, parsing, parser, map viewer, tool, javascript, node, browser, saver, editor, save, edit
  -->
...
*bool*         | dontStarveWorld                 | Dont Starve world (seed) enabled<br>only >1.4.3
*bool*         | notTheBeesWorld                 | Not the bees world (seed) enabled<br>only >1.4.3
*bool*         | remixWorld                      | Remix world (seed) enabled<br>only >1.4.4
*bool*         | noTrapsWorld                    | No traps world (seed) enabled<br>only >1.4.4
*bool*         | zenithWorld                     | Zenith world (seed) enabled<br>only >1.4.4
